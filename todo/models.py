...
class Task(models.Model):
    ...
    importance = models.CharField(max_length=1, choices=IMPORTANCE_CHOICES, null=True, blank=True)


class Completion(models.Model):
    completed_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='completions')
